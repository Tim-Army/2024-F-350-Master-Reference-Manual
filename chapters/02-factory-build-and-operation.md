...
- Available project-recorded views: rear view, 360-degree, rear split view, bed camera, picture-in-picture, and trailer guidance views when equipped.
- For fifth-wheel alignment: select the bed camera, use 360-degree view to monitor surroundings, confirm kingpin alignment, and then verify coupling before travel.
- Hitch-angle display: black line indicates actual trailer position; white line indicates predicted path. Yellow indicates approaching a difficult articulation angle; red indicates stop, pull forward, and realign.
