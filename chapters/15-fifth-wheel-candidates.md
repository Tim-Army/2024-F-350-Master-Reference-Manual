# 15. Fifth-Wheel Candidates

Shortlist of fifth wheels under consideration, and the screening arithmetic that decides whether the truck can pull them.
...
From [chapter 10](10-fifth-wheel-and-towing.md), on the truck's measured figures:
...
### Corrections made on 11 September 2026

A research summary proposed several corrections. Each was checked against the manufacturer; the outcome for each:

| Claim | Verdict | Evidence |
| --- | --- | --- |
| Nightfall 270N GVWR is 14,759 lb | **Correct** - already recorded | Forest River 2027 page |
| Nightfall 270N has an enclosed garage | **Wrong** | Floorplan: dinette, rollovers, fireplace and 5,000 lb tie-downs in a 16 ft garage that opens directly into the kitchen. The "3 season door prep" is at the rear ramp opening, not between garage and living area |
| XLR Boost 286B has an enclosed garage | **Wrong** | Floorplan: two gauchos, removable dinette and fireplace in a 16 ft garage open to the kitchen; 3,000 lb tie-downs |
| XLR Boost 286B GVWR | **Chapter was wrong** - now 14,094 lb, not 13,994 | Forest River 2026: UVW 9,094 + CCC 5,000 |
| XLR Micro Boost 301LRLE GVWR is ~13,900 lb, and 11,495 belongs to another model | **Both wrong** | Forest River spec sheet: UVW 7,938 + CCC 3,907 = **11,845 lb**. Same model - the 1,645 lb pin and 32 ft 6 in length match. The chapter's 11,495 was also wrong, by 350 lb |
| Rogue SUT 323SUT is 34 ft 10 in | **Correct** | Forest River 2026 |
| Rogue SUT 323SUT GVWR is 14,090 lb | **Correct - the chapter was wrong** at 15,090 | Forest River 2026 |
...
| --- | --- | --- | --- | --- | --- |
| Keystone Raptor Carbon **310** (2026, Keystone model page supplied by the owner) | 35 ft 11 in | **16,380** (11,085 shipping + 5,295 CCC) | 2,380 | 22% | **Open concept, shared 20 ft garage** (19 ft 9 in on the floorplan, 72 in wide at the kitchen), dual opposing sofas with queen bed above, swivel chairs, 5,000 lb tie-downs, 94 / 88 / 44 gal, 13 ft 3 in high. Its 21.5% dry pin ratio gives **~3,515 lb at GVWR, about 110 lb under the ceiling**. Workable only with disciplined loading. Added 14 September 2026 |
| Grand Design Momentum 320G | 36 ft 3 in | 16,400 (Grand Design; RVGuide 2025 says 16,800) | 2,300 | 22% | Workable only well under GVWR - **rejected by the owner 14 September 2026: too expensive**. Floorplan shows an **enclosed 11 ft garage** (17 September) |
...
| [Forest River Wolf Pack 315PACK12](https://www.rvguide.com/specs/forest-river/toy-hauler/2024/cherokee-wolf-pack/315pack12.html) | 2023-2024 | 40 ft 7 in | 12 ft (144 in) | **Enclosed** - solid wall with a sliding glass door | 14,260 | 11,220 / 2,260 | 3,040 | 96 gal | ~2,875 | 25% |
...
- **KZ 311TH10 - better than proposed.** The proposed 12,995 lb GVWR and 2,180 lb pin appear on none of KZ's pages; the earlier note (12,500 lb, 3,690 lb CCC) was right. It is the **lightest enclosed-garage trailer found so far, with the most margin** - loaded to GVWR it should sit around 2,300 lb of pin, over 1,300 lb under the ceiling. 2020 units are rated only 11,000 lb, so avoid that year. The floorplan settles the garage: **10 ft** from the screen door to the front wall, an **88 x 91 in ramp door**, and a wall with a hinged door between the garage and the kitchen. Options that matter: a 60 x 84 in power bed over the garage, which reduces headroom when it is lowered, and a 30 gal fuel station, which adds about 185 lb of gasoline when full. KZ's 2023 spec table, confirmed by the owner the same day, adds three details:
...
- **XLR Nitro 321 - moves to marginal.** It is 1 ft longer, has a 1 ft longer garage and is rated **2,590 lb heavier** than proposed. At 16,585 lb it is in the same position as the Triton: workable only well under GVWR.
  - **The weights are manufacturer-confirmed.** The [2023 XLR Nitro brochure](https://assets-cdn.interactcp.com/interactrv/brand_brochure/brand_brochure_20230828110357554499640.pdf), supplied by the owner, lists a 2,585 lb hitch, 12,234 lb UVW, 4,351 lb CCC (16,585 lb GVWR), 37 ft 10 in length, 13 ft 4 in height and 102/71/82 gal tanks. The proposed 36 ft 10 in matches the 2020 model year, per RVUSA.
  - **The floorplan was read from a dealer copy of Forest River's 2023-2024 drawing** ([RVingPlanet](https://www.rvingplanet.com/mfg-forest-river-rv/xlr-nitro-toy-hauler-fifth-wheel/321)); the brochure's floorplan is too low-resolution to read. The garage is 11 ft long and 93 in wide inside, with opposing gaucho sofas, removable tables and an electric queen bed above. The rear opening is marked 80.5 in, probably the ramp door width, which would make it the narrowest of the four. The partition sits where the 11 ft arrow ends, so that figure is clear floor.
  - **The garage is enclosed**, going by Forest River's "11' Separated Garage" and the partition on the plan. The brochure lists 72 in solid passage doors as standard. The drawing is too small to show the door's type.
  - **The garage doubles as a hallway.** One of the two entry doors opens into the front of the garage, next to the half bath, and the brochure lists a panoramic screen and a Gear Guardian garage camera. **The front ~3 ft has to stay clear** as a walkway to the entry door and bath, which leaves roughly 8 ft for the bikes. That is less than the KZ's 10 ft and about the same as the Rogue's, and this trailer is heavier and longer than both.
  - **Other features:** a 30 gal fuel station, 5,000 lb tie-downs, and an optional 5.5 kW Yamaha generator.
- **Wolf Pack 315PACK12 - confirmed for 2023-2024.** The proposed figures match those years exactly. It fits on weight, but it is 5 ft 7 in over the 35 ft preference and has the least cargo capacity of the three.
  - **The garage is enclosed.** This comes from the [2021 Forest River floorplan](https://www.petesrv.com/product/used-2021-forest-river-rv-cherokee-wolf-pack-315pack12-3364464-26) on a dealer listing. Forest River's own page for this discontinued model is gone. The feature text calls it a "12' Separate Garage". **An interior photo, confirmed by the owner, shows a solid wall with a sliding glass door** between the kitchen and the garage, with cabinets above. The door slides rather than swings, so it takes no floor space on either side. RVGuide also lists a soft cargo wall as standard for 2024. That is the screen/tent wall that encloses the rear opening when the ramp door is down in patio mode (confirmed by the owner). It is not a substitute for the solid interior wall.
...
**Pin at GVWR** scales each model's dry pin share of dry weight up to GVWR. The truck's ceiling is ~3,625 lb. **CCC** is the manufacturer's figure; "derived" means GVWR minus dry weight, where CCC is not published. **Height** is the published exterior height; most sources (RVGuide, dealers) do not say whether it includes the A/C, and several figures are from search summaries of dealer pages. Measure before relying on a figure for clearance.
...
| ~~Palomino Puma Unleashed 356QLB~~ **REJECTED** | 2014 | 36 ft 2 in | 13 ft 2 in | **12 ft cargo bay**, 8 ft ramp door, side entry door, **patio door** to the living space, overhead loft bed | **13,243** (2014 brochure; the listing's 14,020 is the 359THKS figure) | 4,000 brochure / 4,035 listing | **2,557** (27.8%) | ~2,697 | **~3,678** | ~3,818 - **over** | Cheapest yet at **$16,922**. Fits by only ~22 lb; no gooseneck option |
...
| Dutchmen Triton 3561 | ~2018 | 38 ft 10 in | 13 ft 4 in (with A/C) | 13 ft; glass patio doors | 16,800 | 4,974 | 2,729 | ~2,869 | ~3,880 | ~4,020 | Over the ceiling at GVWR |
| Keystone Raptor 351 | 2024 | 39 ft | 13 ft 2 in | 11 ft | 17,000 | ~3,244 (derived) | 3,020 | ~3,160 | ~3,725 | ~3,865 | Over the ceiling at GVWR |
| Dutchmen Triton 3551 | ~2018 | 39 ft | 13 ft 4 in (with A/C) | 11 ft; twin bed loft | 16,800 | 4,016 | 2,980 | ~3,120 | ~3,915 | ~4,055 | Over the ceiling at GVWR |
| Alliance Valor 36V11 | 2027 | 39 ft 7 in | 13 ft 4 in (2025) | 11 ft | 18,000 | ~3,719 (derived) | 2,995 | ~3,135 | ~3,775 | ~3,915 | Over the ceiling at GVWR |
| Jayco Seismic 359 | 2027 | 40 ft (41 ft 8 in overall on the 2026 page) | 13 ft 3 in (with A/C) | 11 ft | 17,500 | 4,010 | 2,875 | ~3,015 | ~3,725 | ~3,865 | Over the ceiling at GVWR; check overall length |

**The two gooseneck columns** add **140 lb** to the published pin figures: a Reese Goose Box weighs **212 lb** and replaces a stock pin box of roughly 70 lb, so a conversion costs about that much pin weight. They are estimates on top of estimates - use them for screening, not for a purchase decision. The owner's accepted ceiling is **3,700 lb** ([chapter 10](10-fifth-wheel-and-towing.md)).
...
| 2017 KZ Venom V3411TK | Rejected by the owner 21 September 2026. Towable (pin ~3,032 lb at its 16,000 lb GVWR) but the lowest cargo capacity of the live candidates at 2,700 lb; 13,300 lb dry; $39,995; Roto-Flex pin box may block a Goose Box conversion |
...
**Could it be converted to gooseneck like the Wolf Pack?** **Probably, but it is not free and it is not confirmed.** The Reese Goose Box fits specific pin boxes - **Lippert 1621, 1716, 0719, Rhino and Fabex PB 600**, with the Gen 3 (94920) list adding Lippert 1116, 0115 and RBW 7019/7028. Palomino is a Forest River division and Forest River fifth wheels ride on Lippert frames, so the odds are good, but **the pin box on this specific unit has to be identified by its stamped model number before assuming it**. Rating is not an issue: 20,000 lb gross and 4,000 lb pin against this trailer's 13,560 lb and ~2,617 lb.

**The cost changes the comparison.** A Gen 3 Goose Box runs about **$1,800** new, against **$1,399** for the B&W Companion. So converting the Puma is **more expensive than simply buying the fifth-wheel head** and towing it as built - and it would also add the Goose Box's 212 lb in place of the stock pin box. **Convert only if gooseneck coupling is wanted for its own sake** (a clear bed when unhitched, a tighter turning circle, air ride), not as a way to save money. The Wolf Pack's conversion is worth money precisely because someone else already paid for it.
...
- **Approval and warranty - the Goose Box is the approved way to do this.** Lippert (which builds the frames under Forest River fifth wheels) designated itself the **exclusive RV-industry supplier of the Reese Goose Box**, and Lippert document **CCD-0004318** is the one commonly cited as naming the Goose Box the gooseneck conversion that **does not void the Lippert frame warranty**. The distinction that matters: a **bolt-on adapter clamped to the kingpin voids it**, because it levers on a pin box never designed for that load path; **replacing the whole pin box does not**, because the Goose Box *is* a pin box, just one ending in a gooseneck coupler instead of a kingpin. That is what is fitted here. **Get the document.** Ask the dealer for the Lippert letter or CCD-0004318, the Reese installation instructions, and any paperwork from whoever fitted it - and confirm the trailer's pin box was one of the listed Lippert or Fabex types. **A 2021 trailer is out of its original warranty anyway**, so this matters mainly as evidence the conversion was done the right way rather than improvised.
...
**Garage is shared** (owner, 21 September 2026) - open to the living space, not walled off. A data point rather than a disqualifier under the [requirement](#requirement).
...
### KZ Venom V3411TK (2017) - verified, REJECTED 21 September 2026
...
**Garage verified from the 2023 floorplan, 21 September 2026 - the earlier "~8 ft usable" note was wrong.** The plan shows the **11 ft arrow spanning the garage floor itself**, from the rear wall to the partition at the front, with **opposing gauchos down both side walls, removable tables between them and a bed above**. Interior width is marked **93 in** and the rear opening **80.5 in**. There is no walkway eating into the length; the 11 ft is the garage. **Correct the table's "~8 ft usable" reading.**
...
### Forest River Puma 382THS (2022) - federal label confirmed, REJECTED 22 September 2026
...
### Palomino Puma Unleashed 356QLB (2014) - screened, REJECTED 22 September 2026
...
**The 2014 brochure is the model-year-matched source, and it is the pessimistic one.** The unit is a 2014, so the 2,557 lb figure is the manufacturer's own number *for this model year*; the 1,844 lb comes from the 2016 brochure, a later build. The 2014 brochure is also internally consistent (2,557 hitch + 6,651 axle = 9,208 dry), so it cannot be dismissed as a typo.

**The listing's GVWR is a data error - the brochure proves it.** The 2014 Puma brochure (`imports/Puma-brochure-mak7931.pdf`, added 22 September 2026) gives the 356-QLB a **GVWR of 13,243 lb**. The listing's **14,020 lb is the 359-THKS figure**, the very next column in the same table - the dealer has taken the number from the wrong column. That also explains the 9,935 lb dry weight on the listing, which is nearer the 359THKS's 9,985 lb than the 356QLB's 9,208 lb. **Use the brochure's numbers for this trailer.**
...
**What owners say** (Keystone Forums, searched 25 September 2026). Owner feedback is thin - RV Insider has no 297SE reviews - but what exists is small factory-fit faults, not structural ones. No frame, axle or water-damage reports turned up for this model.

- **2014 owner, 5-6 trips in** ([thread](https://www.keystoneforums.com/threads/any-raptor-297se-input.585295/)): happy with it overall, after a run of first-trip faults - a generator fuel pump failed on a new unit, a gray-tank gauge read a third full when empty, the bath door would not latch when the trailer was leveled unhitched (fixed by moving the strike plate), sink covers missing, and the first furnace run smelled of burning plastic and set off the smoke alarm. Their advice: run the furnace 30-45 minutes on delivery to burn off residue. The exterior tank labels were in the wrong order; front to rear it is **black, gray, gray**.
- **2013 owner** (same thread): the fuel station **held about 20 gal, not the advertised 30**. No one answered with a measurement. For the pin, 10 gal less gasoline at the garage end is about 60 lb less weight behind the axles.
- **Series comparison** ([thread](https://www.keystoneforums.com/threads/raptor-297se-vs-300mp.587841/), 2012): an owner who shopped it against the 300MP called the 297SE **fairly bare-bones**, **without the 300MP's insulation package**, and about **$6,000 cheaper** - consistent with SE being the budget series. Another owner found it had **less storage** than their previous travel trailer and planned cabinets in the garage.
- **Published weights moved between years.** A 2011 shopper found Keystone spec sheets giving the hitch as **2,130 lb and 2,430 lb**; another owner noted published hitch weights are dry and exclude batteries and propane. The 2013 brochure's **2,620 lb** is higher than both, so the ~3,645 lb estimate already uses the heavier figure.
