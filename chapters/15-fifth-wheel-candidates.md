...
**But the listing's figures do not match that brochure either.** The listing gives GVWR **14,020 lb** and dry **9,935 lb**, against the 2014 brochure's 13,243 lb and 9,208 lb - **777 lb and 727 lb apart**. So the listing is not describing the 2014 brochure's trailer: either it carries options the brochure build did not, or the dealer has populated the page with another year's data. **That makes the listing's 1,766 lb pin unreliable as a cross-check**, and leaves the 27.8% share standing as a genuine possibility rather than an outlier to be explained away.
