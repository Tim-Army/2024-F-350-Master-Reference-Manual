...
| [Superior 58-0470B Truckline Sport Grip](https://www.amazon.com/Superior-58-0470B-Truckline-Sport-Steering/dp/B00029KA6I) | **$12.99** | Researching | **Lace-on** - meets the requirement. Truck size, 17 in, fits 16-18 in wheels with grip circumference up to 3.5 in. But **neoprene, not leather** - satisfies the fit requirement while missing the material one. Measure the rim's grip circumference before ordering |
| Lace-on **leather** cover - still open |  | Planned | The original spec was lace-on *and* leather; the Superior above is lace-on neoprene. **No heated steering wheel on this truck** (REF-003), so a laced cover carries no insulation penalty |
