...
| REF-030 | B&W Companion 25K (RVK3305) installation instructions | `imports/RVK3305_Installation_Instructions_….pdf` | 5 | B&W OEM; hitch installation, torque, adjustment, coupling and maintenance - see [chapter 5](05-torque-specifications.md) and [chapter 10](10-fifth-wheel-and-towing.md) | Held |
...
| REF-027 | CAT Scale ticket 1004326254938, 11 Sep 2026 | [`references/REF-027-cat-scale-2026-09-11.pdf`](../references/REF-027-cat-scale-2026-09-11.pdf) | 1 | Truck only with two front-seat occupants; axle weights recorded in [chapter 10](10-fifth-wheel-and-towing.md) and the scale weights log | **In repo** |
| REF-032 | A/C evaporator drain - wide view from the passenger-side wheel well, photographed 21 September 2026 (IMG_1728) | [`references/REF-032-ac-drain-wheel-well-view.jpeg`](../references/REF-032-ac-drain-wheel-well-view.jpeg) | 1 | VIN-specific; the **approach sight line** behind the front tire - inner fender liner, frame rail and foil-wrapped dash panel. Pairs with the REF-031 close-up; see [chapter 11](11-troubleshooting.md) | **In repo** |
| REF-031 | A/C evaporator drain, photographed 21 September 2026 | [`references/REF-031-ac-evaporator-drain.jpeg`](../references/REF-031-ac-evaporator-drain.jpeg) | 1 | VIN-specific; locates the **evaporator drain grommet and slotted drain fitting** in the dash panel - see [chapter 11](11-troubleshooting.md) | **In repo** |
